...
public class ControllerAdvice {
    ...
    protected final ExceptionResponseHandler exceptionResponseHandler;
    ...
    @ExceptionHandler({
            IdempotenceException.class
    })
    @ResponseStatus(HttpStatus.CONFLICT)
    public ResponseEntity<Map<String, String>> extIdempotenceException(Exception ex, HttpServletRequest exchange) {
        return exceptionResponseHandler.getErrorResponse(exchange, HttpStatus.CONFLICT, ex);
    }
    ...
    @ExceptionHandler({
            ...
            NotPermittedAccountException.class,
    })
